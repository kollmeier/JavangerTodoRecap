...
class TodoControllerTest {
    ...
    class addTodoTest {
        ...
        @Test
        @DisplayName("sollte ein neues Todo erstellen und mit korrigiertem Text zurückgeben")
        void addTodo_shouldAddTodoWithOrthographicErrorsAndReturnFixedDTO() throws Exception {
            // Given
        ...
        @Test
        @DisplayName("sollte Status SERVER_ERROR zurückgeben, wenn Open-AI-Service fehler wirft")
        public void addTodo_shouldReturnServerError_whenOpenAiServiceReturnsError() throws Exception {
            // Given
            TodoInputDTO todoInputDTO = new TodoInputDTO("OPEN", "Tset Todo");
            ObjectWriter objectWriter = new ObjectMapper().writer();
            JsonObject jsonTodoInputDTO = new JsonObject(objectWriter.writeValueAsString(todoInputDTO));
        ...
        @Test
        @DisplayName("sollte Todo unverändert lassen, zurückgeben, wenn Open-AI-Service ungültiges Json zurückgibt")
        public void addTodo_shouldReturnServerError_whenOpenAiServiceReturnsInvalidJson() throws Exception {
            // Given
            TodoInputDTO todoInputDTO = new TodoInputDTO("OPEN", "Tset Todo");
            ObjectWriter objectWriter = new ObjectMapper().writer();
            JsonObject jsonTodoInputDTO = new JsonObject(objectWriter.writeValueAsString(todoInputDTO));
            ...
            mockMvc.perform(post("/api/todo").contentType("application/json").content(jsonTodoInputDTO.getJson()))
                    ...
                    .andExpect(content().json("""
                                {
                                    "status": "OPEN",
                                    "description": "Tset Todo"
                                }
                            """));
        }

        @Test
        @DisplayName("sollte Todo unverändert lassen, zurückgeben, wenn Open-AI-Service leeren Content zurückgibt")
        public void addTodo_shouldReturnServerError_whenOpenAiServiceReturnsEmptyContent() throws Exception {
            // Given
            TodoInputDTO todoInputDTO = new TodoInputDTO("OPEN", "Tset Todo");
            ObjectWriter objectWriter = new ObjectMapper().writer();
            JsonObject jsonTodoInputDTO = new JsonObject(objectWriter.writeValueAsString(todoInputDTO));
